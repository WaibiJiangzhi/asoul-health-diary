const VERSION = "asoul-life-v95-0900";
const SHELL_CACHE = `${VERSION}-shell`;
const IMAGE_CACHE = `${VERSION}-images`;
const SHELL = [
  "./",
  "./index.html",
  "./design-system.css?v=0879",
  "./styles.css?v=0875",
  "./weekly-polish.css?v=0863",
  "./complete-polish.css?v=0875",
  "./mobile-app.css?v=0894",
  "./responsive-platform.css?v=0894",
  "./home.css?v=0900",
  "./goals.css?v=0900",
  "./schedule.css?v=0897",
  "./charts.css?v=0897",
  ...
  "./app-utils.js?v=0865",
  "./backup-codec.js?v=0867",
  "./milestone-domain.js?v=0868",
  "./chart-domain.js?v=0868",
  "./schedule-domain.js?v=0868",
  "./stickers.js?v=0821",
  "./冷笑话.js?v=0821",
  "./app.js?v=0899",
  "./favicon.svg",
  "./manifest.webmanifest?v=0843",
  "./icons/1.png?v=0843",
