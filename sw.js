const VERSION = "asoul-life-v17-0820b";
...
const SHELL = [
  ...
  "./index.html",
  "./styles.css?v=0820b",
  "./weekly-planner.css?v=0820b",
  "./weekly-polish.css?v=0820b",
  "./complete-polish.css?v=0820b",
  "./mobile-app.css?v=0820b",
  "./data-model.js?v=0820b",
  "./stickers.js?v=0820b",
  "./冷笑话.js?v=0820b",
  "./app.js?v=0820b",
  "./favicon.svg",
  "./manifest.webmanifest?v=0820b",
  "./icons/icon-192.png?v=0820b",
  "./icons/icon-yigehun.png?v=0820b",
  "./icons/icon-512.png",
